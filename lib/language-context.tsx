...
export const UI_DICTIONARY: Partial<Record<LanguageCode, Record<string, string>>> & { en: Record<string, string> } = {
  en: {
    ...
    // Bank Dashboard
    bank_dashboard: 'Bank Partner Credit & Risk Dashboard',
    facilities_mgmt: 'Financial Facilities Management',
    add_facility: 'Create Credit Product',
  ...
  hi: {
    ...
    // Bank Dashboard
    bank_dashboard: 'बैंक पार्टनर क्रेडिट एवं जोखिम डैशबोर्ड',
    facilities_mgmt: 'वित्तीय सुविधा प्रबंधन',
    add_facility: 'नया ऋण उत्पाद जोड़ें',
    published_facilities: 'सक्रिय ऋण योजनाएं',
    under_review_apps: 'समीक्षाधीन आवेदन',
    total_disbursed: 'कुल वितरित ऋण',

    // Govt Dashboard
    govt_admin_hub: 'सरकारी प्रशासन एवं कस्टम हायरिंग हब',
    chc_machinery: 'कस्टम हायरिंग केंद्र मशीनरी',
    subsidies_disbursed: 'प्रत्यक्ष सब्सिडी वितरण',
  ...
  or: {
    ...
    // Bank Dashboard
    bank_dashboard: 'ବ୍ୟାଙ୍କ କ୍ରେଡିଟ୍ ଓ ବିପଦ ପରିଚାଳନା ଡ୍ୟାସବୋର୍ଡ',
    facilities_mgmt: 'ଋଣ ସୁବିଧା ପରିଚାଳନା',
    add_facility: 'ନୂତନ ଋଣ ଯୋଜନା ଯୋଡନ୍ତୁ',
